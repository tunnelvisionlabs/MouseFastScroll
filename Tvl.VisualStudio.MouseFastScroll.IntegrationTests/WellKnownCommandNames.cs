...
namespace Tvl.VisualStudio.MouseFastScroll.IntegrationTests
{
    public static class WellKnownCommandNames
    {
        ...
        public const string Test_IntegrationTestService_Start = "IntegrationTestService.Start";
        public const string Test_IntegrationTestService_Stop = "IntegrationTestService.Stop";
